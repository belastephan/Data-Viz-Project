...
## Project Description
The aim of this project is to analyze the data base of available hosts on Airbnb from jun08 to aug15 in New York City. Besides understanding the best type of accommodation and location to be invested in recommended by an investor so hosts may set up their accomodations on Airbnb plataform. Tableau Public was the BI tool used to present the data and insights in a structured way through tableaus, graphs, dashboards and stories visions.
